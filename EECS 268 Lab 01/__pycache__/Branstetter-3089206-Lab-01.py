    ...
    def __init__(self, file_name):
        with open(file_name) as f:  # read the file
            ...
            for row in rows_data:
                # create broadgame objects and add them to a list
                l.append(BoardGame(
                    name=row[0], year=row[1], GR=row[2], PR=row[3], MP=row[4], MT=row[5]))
